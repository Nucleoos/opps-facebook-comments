...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'facebookcomments_topcomment', (
            ...
            ('post', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['containers.Container'], unique=True)),
    ...
    models = {
        ...
        u'facebookcomments.topcomment': {
            ...
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['containers.Container']", 'unique': 'True'}),
