...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopComment'
        db.create_table(u'facebookcomments_topcomment', (
            ...
            ('%s' % (User._meta.module_name), self.gf('django.db.models.fields.related.ForeignKey')(to=orm["%s.%s" % (User._meta.app_label, User._meta.object_name)])
            ...
            ('container', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['containers.Container'], unique=True)),
            ('profile_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('comment_text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('comment_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'facebookcomments', ['TopComment'])


    def backwards(self, orm):
        # Deleting model 'TopComment'
        db.delete_table(u'facebookcomments_topcomment')
    ...
    models = {
        ...
        u'channels.channel': {
            ...
            '%s' % (User._meta._module_name): ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['%s.%s']" % (User._meta.app_label, User._meta.object_name)})
        },
        u'containers.container': {
            ...
            '%s' % (User._meta.module_name): ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['%s.%s']" % (User._meta.app_label ,User._meta.object_name)})
        },
        ...
        u'facebookcomments.topcomment': {
            ...
            'container': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['containers.Container']", 'unique': 'True'}),
