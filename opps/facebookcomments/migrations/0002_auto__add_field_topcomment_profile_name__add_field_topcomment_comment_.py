...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopComment.profile_name'
        db.add_column(u'facebookcomments_topcomment', 'profile_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'TopComment.comment_text'
        db.add_column(u'facebookcomments_topcomment', 'comment_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopComment.profile_name'
        db.delete_column(u'facebookcomments_topcomment', 'profile_name')

        # Deleting field 'TopComment.comment_text'
        db.delete_column(u'facebookcomments_topcomment', 'comment_text')
